...
export declare class OwlDateTimeInputDirective<T> implements OnInit, AfterContentInit, OnDestroy, ControlValueAccessor, Validator {
    ...
    private isSameValue;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<OwlDateTimeInputDirective<any>, [null, null, { optional: true; }, { optional: true; }]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<OwlDateTimeInputDirective<any>, "input[owlDateTime]", ["owlDateTimeInput"], { "rangeSeparator": "rangeSeparator"; "owlDateTime": "owlDateTime"; "owlDateTimeFilter": "owlDateTimeFilter"; "min": "min"; "max": "max"; "selectMode": "selectMode"; "value": "value"; "values": "values"; "_disabled": "_disabled"; }, { "dateTimeChange": "dateTimeChange"; "dateTimeInput": "dateTimeInput"; }, never>;
}

//# sourceMappingURL=date-time-picker-input.directive.d.ts.map