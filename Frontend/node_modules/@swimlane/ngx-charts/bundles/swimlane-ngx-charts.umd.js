(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.swimlane = global.swimlane || {}, global.swimlane['ngx-charts'] = {}), global.ng.core, global.ng.common, global.ng.animations, global.ng.cdk.portal, global.rxjs, global.rxjs.operators, global.d3Selection, global.d3Brush, global.d3Scale, global.d3Shape, global.d3Array, global.d3Interpolate, global.d3Format, global.d3_color, global.d3Hierarchy, global.d3TimeFormat));
    ...
    ***************************************************************************** */
    ...
    var ChartComponent = /** @class */ (function () {
        ...
        ChartComponent.prototype.getLegendType = function () {
            return this.legendOptions.scaleType === exports.ɵc.Linear ? exports.LegendType.ScaleLegend : exports.LegendType.Legend;
        };
    ...
    var BaseChartComponent = /** @class */ (function () {
        function BaseChartComponent(chartElement, zone, cd, platformId) {
            ...
            this.platformId = platformId;
            this.scheme = 'cool';
            this.schemeType = exports.ɵc.Ordinal;
            this.animations = true;
    ...
    var CircleSeriesComponent = /** @class */ (function () {
        ...
        CircleSeriesComponent.prototype.mapDataPointToCircle = function (d, i) {
            ...
            var cx;
            if (this.scaleType === exports.ɵc.Time) {
                cx = this.xScale(label);
            }
            else if (this.scaleType === exports.ɵc.Linear) {
            ...
            var opacity = 1;
            var color;
            if (this.colors.scaleType === exports.ɵc.Linear) {
    ...
    var GridPanelSeriesComponent = /** @class */ (function () {
        ...
        GridPanelSeriesComponent.prototype.getGridPanels = function () {
            ...
            return this.data.map(function (d) {
                ...
                if (_this.orient === GridOrientation.Vertical) {
                ...
                else if (_this.orient === GridOrientation.Horizontal) {
    ...
    })(exports.TimelineScaleType || (exports.TimelineScaleType = {}));
    var Timeline = /** @class */ (function () {
        ...
        Timeline.prototype.getXDomain = function () {
            ...
            var domain = [];
            if (this.scaleType === exports.TimelineScaleType.Time) {
                var min = Math.min.apply(Math, __spread(values));
                var max = Math.max.apply(Math, __spread(values));
                domain = [min, max];
            }
            else if (this.scaleType === exports.TimelineScaleType.Linear) {
        ...
        Timeline.prototype.getXScale = function () {
            ...
            else if (this.scaleType === exports.TimelineScaleType.Ordinal) {
    ...
    function calculateViewDimensions(_a) {
        ...
        if (showLegend && legendPosition === exports.LegendPosition.Right) {
            if (legendType === exports.ɵc.Ordinal) {
                columns -= 2;
            }
            else {
                columns -= 1;
    ...
    var ColorHelper = /** @class */ (function () {
        ...
        ColorHelper.prototype.getColor = function (value) {
            ...
            if (this.scaleType === exports.ɵc.Linear) {
    ...
    function getScaleType(values, checkDateType) {
        ...
        if (checkDateType) {
            ...
            if (allDates) {
                return exports.ɵc.Time;
            }
        }
        var allNumbers = values.every(function (value) { return typeof value === 'number'; });
        if (allNumbers) {
            return exports.ɵc.Linear;
        }
        return exports.ɵc.Ordinal;
    }
    ...
    var AreaChartComponent = /** @class */ (function (_super) {
        ...
        AreaChartComponent.prototype.getXDomain = function () {
            ...
            var min;
            var max;
            if (this.scaleType === exports.ɵc.Time || this.scaleType === exports.ɵc.Linear) {
        ...
        AreaChartComponent.prototype.getXScale = function (domain, width) {
            ...
            else if (this.scaleType === exports.ɵc.Ordinal) {
        ...
        AreaChartComponent.prototype.setColors = function () {
            var domain;
            if (this.schemeType === exports.ɵc.Ordinal) {
        ...
        AreaChartComponent.prototype.getLegendOptions = function () {
            ...
            if (opts.scaleType === exports.ɵc.Ordinal) {
                ...
                try {
                    for (var _c = (e_1 = void 0, __values(this_1.results)), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        var d = group.series.find(function (item) {
                            var a = item.name;
                            var b = val;
                            if (_this.scaleType === exports.ɵc.Time) {
                                a = a.valueOf();
                                b = b.valueOf();
                            }
                            return a === b;
    ...
    var AreaSeriesComponent = /** @class */ (function () {
        ...
        AreaSeriesComponent.prototype.update = function () {
            ...
            else if (this.scaleType === exports.ɵc.Time) {
    ...
    var BarVertical2DComponent = /** @class */ (function (_super) {
        ...
        function BarVertical2DComponent() {
            ...
            _this.legendPosition = exports.LegendPosition.Right;
            _this.tooltipDisabled = false;
            _this.scaleType = exports.ɵc.Ordinal;
            _this.showGridLines = true;
            _this.activeEntries = [];
            _this.trimXAxisTicks = true;
            _this.trimYAxisTicks = true;
    ...
    var SeriesHorizontal = /** @class */ (function () {
        ...
        SeriesHorizontal.prototype.update = function () {
            ...
            this.bars = this.series.map(function (d) {
                ...
                if (_this.colors.scaleType === exports.ɵc.Ordinal) {
    ...
    function getDomain(values, scaleType, autoScale, minVal, maxVal) {
        var domain = [];
        if (scaleType === exports.ɵc.Linear) {
            values = values.map(function (v) { return Number(v); });
            if (!autoScale) {
                values.push(0);
            }
        }
        if (scaleType === exports.ɵc.Time || scaleType === exports.ɵc.Linear) {
    ...
    var BubbleChartComponent = /** @class */ (function (_super) {
        ...
        function BubbleChartComponent() {
            ...
            _this.maxRadius = 10;
            _this.minRadius = 3;
            _this.schemeType = exports.ɵc.Ordinal;
            _this.tooltipDisabled = false;
            _this.activate = new core.EventEmitter();
            _this.deactivate = new core.EventEmitter();
            _this.scaleType = exports.ɵc.Linear;
            _this.margin = [10, 20, 10, 20];
        ...
        BubbleChartComponent.prototype.update = function () {
            ...
            this.yDomain = this.getYDomain();
            this.transform = "translate(" + this.dims.xOffset + "," + this.margin[0] + ")";
            var colorDomain = this.schemeType === exports.ɵc.Ordinal ? this.seriesDomain : this.rDomain;
                ...
                for (var _c = __values(this.data), _d = _c.next(); !_d.done; _d = _c.next()) {
                    ...
                    try {
                        for (var _e = (e_2 = void 0, __values(s.series)), _f = _e.next(); !_f.done; _f = _e.next()) {
                            ...
                            var cx = this.xScaleType === exports.ɵc.Linear ? this.xScale(Number(d.x)) : this.xScale(d.x);
                            var cy = this.yScaleType === exports.ɵc.Linear ? this.yScale(Number(d.y)) : this.yScale(d.y);
        ...
        BubbleSeriesComponent.prototype.getCircles = function () {
            ...
            return this.data.series
                ...
                if (typeof d.y !== 'undefined' && typeof d.x !== 'undefined') {
                    ...
                    var cx = _this.xScaleType === exports.ɵc.Linear ? _this.xScale(Number(x)) : _this.xScale(x);
                    var cy = _this.yScaleType === exports.ɵc.Linear ? _this.yScale(Number(y)) : _this.yScale(y);
                    var color = _this.colors.scaleType === exports.ɵc.Linear ? _this.colors.getColor(r) : _this.colors.getColor(seriesName);
    ...
    var HeatMapComponent = /** @class */ (function (_super) {
        ...
        HeatMapComponent.prototype.getLegendOptions = function () {
            return {
                ...
                domain: this.valueDomain,
                colors: this.scaleType === exports.ɵc.Ordinal ? this.colors : this.colors.scale,
                title: this.scaleType === exports.ɵc.Ordinal ? this.legendTitle : undefined,
                position: this.legendPosition
            };
        };
    ...
    var LineSeriesComponent = /** @class */ (function () {
        ...
        LineSeriesComponent.prototype.getLineGenerator = function () {
            ...
            return d3Shape.line()
                ...
                else if (_this.scaleType === exports.ɵc.Linear) {
    ...
    var PolarChartComponent = /** @class */ (function (_super) {
        ...
        PolarChartComponent.prototype.setColors = function () {
            var domain = this.schemeType === exports.ɵc.Ordinal ? this.seriesDomain : this.yDomain.reverse();
            this.colors = new ColorHelper(this.scheme, this.schemeType, domain, this.customColors);
        };
    ...
    var PolarSeriesComponent = /** @class */ (function () {
        ...
        PolarSeriesComponent.prototype.update = function () {
            ...
            var data = this.sortData(this.data.series);
            var seriesName = this.data.name;
            var linearScaleType = this.colors.scaleType === exports.ɵc.Linear;
        ...
        PolarSeriesComponent.prototype.updateGradients = function () {
            this.hasGradient = this.gradient || this.colors.scaleType === exports.ɵc.Linear;
            if (!this.hasGradient) {
                return;
            }
            this.gradientId = 'grad' + id().toString();
    ...
    var AdvancedPieChartComponent = /** @class */ (function (_super) {
        ...
        AdvancedPieChartComponent.prototype.setColors = function () {
            this.colors = new ColorHelper(this.scheme, exports.ɵc.Ordinal, this.domain, this.customColors);
        };
    ...
    var PieGridComponent = /** @class */ (function (_super) {
        ...
        PieGridComponent.prototype.setColors = function () {
            this.colorScale = new ColorHelper(this.scheme, exports.ɵc.Ordinal, this.domain, this.customColors);
        };
    ...
    var LinearGaugeComponent = /** @class */ (function (_super) {
        ...
        LinearGaugeComponent.prototype.setColors = function () {
            this.colors = new ColorHelper(this.scheme, exports.ɵc.Ordinal, [this.value], this.customColors);
        };
