...
export declare class FileInputComponent extends FileInputMixinBase implements MatFormFieldControl<FileInput>, ControlValueAccessor, OnInit, OnDestroy, DoCheck {
    ...
    ngOnDestroy(): void;
    ngDoCheck(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<FileInputComponent, [null, null, null, null, { optional: true; self: true; }, { optional: true; }, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<FileInputComponent, "ngx-mat-file-input", never, { "autofilled": "autofilled"; "accept": "accept"; "value": "value"; "placeholder": "placeholder"; "required": "required"; "disabled": "disabled"; "multiple": "multiple"; "valuePlaceholder": "valuePlaceholder"; "errorStateMatcher": "errorStateMatcher"; }, {}, never, never>;
}
